  ...
  return (
    <div className={styles.wrapper}>
      ...
      <p className={styles}>
        Варіанти оплати:
        <ul>
          <li className={styles} >при оформленні замовлення на сайті передоплата 100%.</li>
          <li className={styles} >при оформленні замовлення на сторінці в Інстаграм мінімальна передоплата 50% на картку ПриватБанку.
